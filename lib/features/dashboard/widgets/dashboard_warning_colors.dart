...
/// a brightness-aware amber accent for pending/at-risk dashboard states
/// (e.g. pending-payment invoices, receivables) without hardcoding a color
/// that already has a home in [ColorScheme].
class DashboardWarningColors {
  const DashboardWarningColors._();
